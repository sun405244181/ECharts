...
import com.funshion.dao.sdkmanager.AppDownloadInstallDao;

public class AppDoanloadInstallServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<AppDownloadInstallInfo> installInfos = AppDownloadInstallDao.getAppInstallInfos(romVer, sdkVer, app, date);
