...
public class P2pErrorCode {
	...
	public P2pErrorCode(String romVer, int sdkVer, String app, int errorCode, int count, int date) {
		super();
		this.romVer = romVer;
		this.sdkVer = sdkVer;
		this.app = app;
	...
	public String toString() {
		return "P2pErrorCode [romVer=" + romVer + ", sdkVer=" + sdkVer + ", app=" + app + ", errorCode=" + errorCode
